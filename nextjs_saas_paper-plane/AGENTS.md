...
- If Resend email copy changed, verify a completed test subscription still sends the welcome email and the webhook still returns 200, and that `/api/health` still reports `resendEmailConfigured`.
